...
public class Party {
    ...
    public String getRank() {
        ...
        List<Integer> ranks = this.getAdventurers().stream().map(a -> rankToNumber.get(a.getAdventurer_rank()))
        ...
        ranks.remove(0);
        if (ranks.size() == 0)
            return this.getAdventurers().get(0).getAdventurer_rank();
